    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'conversations-pdf/<year:\d+>' => 'conversations/pdf',
                ...
                'pdf/<year:\d+>' => 'feedback/pdf',
                'user-pdf/<year:\d+>/<id:\d+>' => 'feedback/user-pdf',
                'annual-pdf/<year:\d+>' => 'annual/pdf',
                'annual-user-pdf/<year:\d+>/<id:\d+>' => 'annual/user-pdf',
            ],
        ],
