<h2>Dear <?= $user_how->first_name . ' ' . $user_how->last_name ?>, </h2>
<p>
    <en> <?= $user->first_name . ' ' . $user->last_name ?> </en>
    would appreciate if you would provide feedback on your
    ...
    would be great to have your feedback within one week of this request.
</p>

<a href="<?= \Yii::$app->params['domain'] ?>/give-feedback/<?= $year . '/' . $model->id ?>">LINK</a>
