...
<div class="main-content">
    ...
    <section class="gray-bg common-block">
        ...
        <div class="container">
            <div class="table-title flex"><img src="/html/assets/images/icons/feedback-provided.png">Provide feedback | <?= $year ?>
            </div>
            <?php if ($model->type == \common\models\Feedbacks::TYPE_EXTERNAL): ?>
                <div class="request-body flex">
                    <div>
                        <input type="text" name="Feedbacks[user_name]" disabled value="<?= $model->user_name ?>"
                               placeholder="Name">
                    </div>
                </div>
            <?php endif; ?>
            <div class="request-body flex">
                <?php if ($model->type == \common\models\Feedbacks::TYPE_EXTERNAL): ?>
                    <div>
                        <input type="text" name="Feedbacks[user_position]" disabled value="<?= $model->user_position ?>"
                ...
                <div class="flex">
                    ...
                    <div class="common-item">
                        <textarea placeholder="Write your comments here" readonly
                                  name="Feedbacks[critical_thinking]"><?= $model->critical_thinking ?></textarea>
                    </div>
                    <div class="line"></div>
                    <div class="common-item">
                    ...
                    <div class="common-item">
                        <textarea placeholder="Write your comments here" readonly
                                  name="Feedbacks[builds]"><?= $model->builds ?></textarea>
                    </div>
                    <div class="line"></div>
                    <div class="common-item">
                    ...
                    <div class="common-item">
                        <textarea placeholder="Write your comments here" readonly
                                  name="Feedbacks[results]"><?= $model->results ?></textarea>
                    </div>
                </div>
            </div>
            <div class="common-list">
                ...
                <div class="flex">
                    ...
                    <div class="common-item">
                        <div class="radio-list" value="<?= $model->collaboration ?>">
                            <label>
                                <input type="radio" name="Feedbacks[collaboration]" disabled value="0"><span></span><em>Strongly
                                    Agree </em>
                            </label>
                            <label>
