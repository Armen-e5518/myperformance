    ...
    <section class="gray-bg common-block">
        ...
        <div class="container">
            <?php if (Yii::$app->session->hasFlash('success')): ?>
                <div class="alert alert-success alert-dismissable">
                    ...
                    <h4><i class="icon fa fa-check"></i> Your annual report has been successfully submitted!</h4>
            ...
            <?php if (Yii::$app->session->hasFlash('error') ): ?>
                <div class="alert alert-danger alert-dismissable">
                    <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                    <h4><i class="icon fa fa-check"></i> Submission error!</h4>
                    <?= Yii::$app->session->getFlash('error') ?>
                </div>
            <?php endif; ?>
            <div class="table-title flex"><img src="/html/assets/images/icons/team-members-feedback.png">Personal
                development plan | assessment - <?= \backend\models\User::GetCurrentUserName() ?> | <?= $year ?></div>
            ...
            <div class="common-list">
                ...
                <div class="flex">
                    <div class="common-item">
                        <textarea readonly><?= $manager['manager_comment'] ?></textarea>
                    </div>
                </div>
            </div>
        </div>
        <?php if (empty($development_state['status'])): ?>
            <div align="center" class="save-submit">
                ...
                <a href="/development/submit?year=<?= $year ?>" class="long-btn">Submit</a>
            </div>
        <?php endif; ?>
